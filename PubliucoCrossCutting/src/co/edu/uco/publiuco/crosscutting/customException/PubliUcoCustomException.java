package co.edu.uco.publiuco.crosscutting.customException;
...
public class PubliUcoCustomException extends RuntimeException {
	...
	protected PubliUcoCustomException(final Throwable rootException,final String technicalMessage,final String userMessage,
