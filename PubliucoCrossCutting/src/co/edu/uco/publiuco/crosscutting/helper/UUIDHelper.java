...
public class UUIDHelper {
	...
	public static final UUID getUUIDFromString(final String value) {
		try {
			...
			throw CrosscuttingCustomException.createTechnicalException(Messages.UUIDHelper.TECHICAL_UUID_FROM_STRING_INAVLID, exception);
		}catch (final Exception exception) {
			throw CrosscuttingCustomException.createTechnicalException(Messages.UUIDHelper.TECNICAL_UUID_FROM_STRING_UNEXPECTED_ERROR, exception);
		}
	}
